...
namespace Creacion_PDF_HelloLetter
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void CargarPDF()
        {
            ...
            foreach (DataRow fila in dt.Rows)
            {
                ...
                string apellidos = fila["APELLIDOS"].ToString();
                ...
                string fechaEnvio = "8 de octubre de 2024";
                string fechaComunicado = "30 de septiembre de 2024";

                string rutaArchivos = Path.Combine(ruta, "OneDrive - MC PROINVEST, S.L/Proyectos/HelloLetters/ArborKnot/" + cartera);
                string rutaArchivosGeneral = Path.Combine(ruta, "OneDrive - MC PROINVEST, S.L/Proyectos/HelloLetters/ArborKnot/" + cartera + "/General");
                ...
                var exportarPDF = "";
                //if (cp >= 31000 && cp < 32000) exportarPDF = Path.Combine(rutaArchivosNavarra, "Hello_" + refEnvio + "_" + idCliente + "_" + expediente + ".pdf");
                //else if (cp >= 3000 && cp < 4000 || cp >= 12000 && cp < 13000 || cp >= 46000 && cp < 47000) exportarPDF = Path.Combine(rutaArchivosValencia, "Hello_" + refEnvio + "_" + idCliente + "_" + expediente + ".pdf");
                //else exportarPDF = Path.Combine(rutaArchivosGeneral, "Hello_" + refEnvio + "_" + idCliente + "_" + expediente + ".pdf");
                exportarPDF = Path.Combine(rutaArchivosGeneral, "Hello_" + refEnvio + "_" + idCliente + "_" + expediente + ".pdf");
                ...
                using (var writter = new PdfWriter(exportarPDF))
                {
                    using (var pdf = new PdfDocument(writter))
                    {
                        ...
                        string rutaLogoDch = Path.GetFullPath(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), rutaArchivos, "Lgo_IDfinance.jpg"));
                        ...
                        prfPrimero.Add(new Text(expediente).SetFont(boldFont));

                        prfPrimero.Add("\r\n\r\nMuy Sr./a. nuestro/a:\r\n\r\nPor la presente le comunicamos que con fecha " + fechaComunicado + ", ");
                        prfPrimero.Add(new Text(cartera).SetFont(boldFont));
                        prfPrimero.Add(" (el “");
                        ...
                        prfPrimero.Add("“), que ostenta frente a usted en su calidad de Titular, con un saldo pendiente a fecha de " + fechaComunicado + " de ");
                        ...
                        prfTercero.Add(new Text("\r\n\r\n\r\nID FINANCE\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tAKCP EUROPE SCSP").SetFont(boldFont));
                        doc.Add(prfTercero);

                        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

                        string rutaFirmaIzq = Path.GetFullPath(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), rutaArchivos, "Firma_Izq.png"));
                        ...
                        var firmaDch = new iText.Layout.Element.Image(imagenDataFirmaDch)
                            .SetPageNumber(2)
                            .SetRelativePosition(285, -85, 1, 1)
                            .SetMaxWidth(180);
    ...
    /*public partial class Form1 : Form
    {
        ...
        private void CargarPDF()
        {
            ...
            foreach (DataRow fila in dt.Rows)
            {
                ...
                string fechaEnvio = "1 de octubre de 2024";
                string fechaComunicado = "25 de septiembre de 2024";

                string rutaArchivos = Path.Combine(ruta, "OneDrive - MC PROINVEST, S.L/Proyectos/HelloLetters/ArborKnot/SmartCredit");
                string rutaArchivosGeneral = Path.Combine(ruta, "OneDrive - MC PROINVEST, S.L/Proyectos/HelloLetters/ArborKnot/SmartCredit/General");
                //string rutaArchivosNavarra = Path.Combine(ruta, "OneDrive - MC PROINVEST, S.L/Proyectos/HelloLetters/ArborKnot/Orange/Navarra");
                //string rutaArchivosValencia = Path.Combine(ruta, "OneDrive - MC PROINVEST, S.L/Proyectos/HelloLetters/ArborKnot/Orange/Valencia");
                if (!Directory.Exists(rutaArchivos)) Directory.CreateDirectory(rutaArchivos);
                if (!Directory.Exists(rutaArchivosGeneral)) Directory.CreateDirectory(rutaArchivosGeneral);
                ...
                using (var writter = new PdfWriter(exportarPDF))
                {
                    using (var pdf = new PdfDocument(writter))
                    {
                        ...
                        encabezadoIzq.Add(logoIzq);
                        doc.Add(encabezadoIzq);
                        string rutaLogoDch = Path.GetFullPath(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), rutaArchivos, "Logo_SmartCredito.jpg"));
                        ImageData imagenDataDch = ImageDataFactory.Create(rutaLogoDch);
                        var logoDch = new iText.Layout.Element.Image(imagenDataDch)
                            .SetFixedPosition(1, 450, 710)
                            .SetMaxWidth(80);
                        Paragraph encabezadoDch = new Paragraph("");
                        encabezadoDch.Add(logoDch);
                        doc.Add(encabezadoDch);
                        ...
                        prfPrimero.Add("\r\n\r\nMuy Sr./a. nuestro/a:\r\n\r\nPor la presente le comunicamos que con fecha " + fechaComunicado + ", ");
                        prfPrimero.Add(new Text("Smart Credito").SetFont(boldFont));
                        prfPrimero.Add(" (el “");
                        prfPrimero.Add(new Text("Cedente").SetFont(boldFont));
                        prfPrimero.Add("“) cedió a ");
                        prfPrimero.Add(new Text("AKCP Europe SCSp").SetFont(boldFont));
                        ...
                        prfTercero.Add(new Text("\r\n\r\n\r\nSMART CREDITO\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tAKCP EUROPE SCSP").SetFont(boldFont));
                        doc.Add(prfTercero);
                        ...
                        var firmaDch = new iText.Layout.Element.Image(imagenDataFirmaDch)
                            .SetPageNumber(2)
                            .SetRelativePosition(285, -55, 1, 1)
                            .SetMaxWidth(180);
                        Paragraph firmaPrfDch = new Paragraph("");
                        firmaPrfDch.Add(firmaDch);
                        doc.Add(firmaPrfDch);
    ...
    /*public partial class Form1 : Form
    {
        ...
        private void CargarPDF()
        {
            ...
            foreach (DataRow fila in dt.Rows)
            {
                ...
                string municipio = fila["MUNICIPIO"] != DBNull.Value ? fila["MUNICIPIO"].ToString() : "";
                int cp = fila["CP"] != DBNull.Value ? Convert.ToInt32(fila["CP"]) : 0;
                string envios = fila["ENVIO"].ToString();
                ...
                string fechaComunicado = string.Empty;
                if (envios == "AvaFin")
                {
                    fechaEnvio = "22 de julio de 2024";
                    fechaComunicado = "19 de julio de 2024";
                }
                else if (envios == "Creamfinance")
                {
                    fechaEnvio = "23 de agosto de 2024";
                    fechaComunicado = "19 de agosto de 2024";
                }

                string rutaArchivos = Path.Combine(ruta, "OneDrive - MC PROINVEST, S.L/Proyectos/HelloLetters/ArborKnot/CreamFinance");
                string rutaArchivosGeneral = Path.Combine(ruta, "OneDrive - MC PROINVEST, S.L/Proyectos/HelloLetters/ArborKnot/CreamFinance/General");
                //string rutaArchivosNavarra = Path.Combine(ruta, "OneDrive - MC PROINVEST, S.L/Proyectos/HelloLetters/ArborKnot/Orange/Navarra");
                //string rutaArchivosValencia = Path.Combine(ruta, "OneDrive - MC PROINVEST, S.L/Proyectos/HelloLetters/ArborKnot/Orange/Valencia");
                if (!Directory.Exists(rutaArchivos)) Directory.CreateDirectory(rutaArchivos);
                if (!Directory.Exists(rutaArchivosGeneral)) Directory.CreateDirectory(rutaArchivosGeneral);
                ...
                using (var writter = new PdfWriter(exportarPDF))
                {
                    using (var pdf = new PdfDocument(writter))
                    {
                        ...
                        encabezadoIzq.Add(logoIzq);
                        doc.Add(encabezadoIzq);
                        string rutaLogoDch = Path.GetFullPath(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), rutaArchivos, "Logo_CreamFinance.png"));
                        ImageData imagenDataDch = ImageDataFactory.Create(rutaLogoDch);
                        var logoDch = new iText.Layout.Element.Image(imagenDataDch)
                            .SetFixedPosition(1, 370, 720)
                            .SetMaxWidth(160);
                        Paragraph encabezadoDch = new Paragraph("");
                        encabezadoDch.Add(logoDch);
                        doc.Add(encabezadoDch);
                        ...
                        prfPrimero.Add("\r\n\r\nMuy Sr./a. nuestro/a:\r\n\r\nPor la presente le comunicamos que con fecha " + fechaComunicado + ", ");
                        prfPrimero.Add(new Text("Creamfinance").SetFont(boldFont));
                        prfPrimero.Add(" (el “");
                        prfPrimero.Add(new Text("Cedente").SetFont(boldFont));
                        prfPrimero.Add("“) cedió a ");
                        prfPrimero.Add(new Text("AKCP Europe SCSp").SetFont(boldFont));
                        ...
                        prfTercero.Add(new Text("\r\n\r\n\r\nCREAMFINANCE\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tAKCP EUROPE SCSP").SetFont(boldFont));
                        doc.Add(prfTercero);
    ...
    /*public partial class Form1 : Form
    {
        ...
        private void CargarPDF()
        {
            ...
            foreach (DataRow fila in dt.Rows)
            {
                ...
                //string origenBanco = "Banco Santander"; //Crisalida 4
                string origenBanco = fila["Origen Bancario"].ToString(); //Crisalida 5 y 6 Banco Santander
                ...
                string paginasEsp = "53"; //Crisalida 6
                string paginasInv = "53 a 55"; //Crisalida 6
                ...
                if (origen == "Axactor Capital Luxemburgo S.A.R.L.") //"Axactor Capital Luxemburgo S.A.R.L."
                {
                    ...
                    if (iCP >= 31000 && iCP < 32000) exportarPDF = Path.Combine(rutaArchivosNavarraL, "Hello_" + refEnvio + "_" + idCliente + "_" + refMC + ".pdf");
                    else if (iCP >= 3000 && iCP < 4000 || iCP >= 12000 && iCP < 13000 || iCP >= 46000 && iCP < 47000) exportarPDF = Path.Combine(rutaArchivosValenciaL, "Hello_" + refEnvio + "_" + idCliente + "_" + refMC + ".pdf");
                    else exportarPDF = Path.Combine(rutaArchivosGeneralL, "Hello_" + refEnvio + "_" + idCliente + "_" + refMC + ".pdf");
                ...
                else if (origen == "Axactor Invest 1 SARL") //"Axactor Invest 1 SARL"
                {
                    ...
                    if (iCP >= 31000 && iCP < 32000) exportarPDF = Path.Combine(rutaArchivosNavarraI, "Hello_" + refEnvio + "_" + idCliente + "_" + refMC + ".pdf");
                    else if (iCP >= 3000 && iCP < 4000 || iCP >= 12000 && iCP < 13000 || iCP >= 46000 && iCP < 47000) exportarPDF = Path.Combine(rutaArchivosValenciaI, "Hello_" + refEnvio + "_" + idCliente + "_" + refMC + ".pdf");
    ...
    /*public partial class Form1 : Form
    {
        ...
        private void CargarPDF()
        {
            ...
            {
                string refEnvio = fila["REF_ENVIO"].ToString();
                string expediente = fila["REF_MC"].ToString();
                string importe = fila["IMPORTE"].ToString();
                string nombre = fila["NOMBRE"].ToString();
